...
Route::middleware(['auth', 'can:admin-access'])->group(function () {
    ...
    Route::get('reports/budget-by-line-item', [App\Http\Controllers\ReportController::class, 'budgetByLineItem'])->name('reports.by_line_item');
    Route::get('reports/by_transactions', [App\Http\Controllers\ReportController::class, 'byTransactions'])->name('reports.by_transactions');
});
